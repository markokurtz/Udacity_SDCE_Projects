...
// align values to be places in fg vector
size_t x_start = 0;
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // all non actuators upper and lower limits
  ...
  // upper and lower limits of delta are set to -25 to 25 degrees (in radians)
